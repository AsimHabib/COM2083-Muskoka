		...
		<div class="col-md-10 col-sm-9">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8"> <span>
					<form class="search" action="staff.php" method="GET">
				...
				<div class="col-md-12 border">
					<ul>
						...
						foreach ($campers as $camper)	{
							echo '<li><a href="payment-info.php?camper_id='. $camper ['camper_id'] .'">' . $camper['camper_first_name'] ."  ". $camper['camper_last_name'] . '</a></li>';	
							}
						} else{
