				...
				<div class="col-md-12 border">
					<ul>
						<?php						
							...
							$getDate_2 = strtotime($camp['camp_reg_date']);
							$getDate_2 = date("Y-m-d",$getDate_2);
								
								echo '<li><a href="parent-sign-sheet.php?camp_reg_date='.$getDate_2.'">' . date("l F d, Y", $getDate) .'</a></li>'; 
							}
